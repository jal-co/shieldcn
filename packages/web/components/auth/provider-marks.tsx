 ...
 *
 * Minimal inline SVG marks for the OAuth providers on the auth form. Kept local
 * so the auth surface has no icon-library dependency; GitHub uses currentColor,
 * Google keeps its brand colors.
 */
...
export function GoogleMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path fill="#EA4335" d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.44-3.44A11.5 11.5 0 0 0 12 0 12 12 0 0 0 1.28 6.62l3.99 3.09C6.22 6.86 8.87 4.75 12 4.75Z" />
    </svg>
  )
}
