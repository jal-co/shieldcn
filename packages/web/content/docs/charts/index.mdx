...
access. The [shieldcn starchart action](/docs/charts/star-history) fetches
...
[issues](#github-issues-over-time), [commits](#github-commits-over-time), or
[npm downloads](#npm-downloads) chart. The plain
[stars count badge](/docs/badges/github) still works — it uses the repo
