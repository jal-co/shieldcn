---
title: Charts
description: Shadcn-styled graphs for GitHub stars, issues, lifetime commit history, npm downloads, and your own JSON data — rendered as portable SVGs.
---

Shadcn-styled line/area charts you can drop in a README, docs site, or anywhere
an image works — plain SVG, no JavaScript, no iframe. Five kinds: GitHub star history,
...
[Star history charts](/docs/charts/star-history) use GitHub's privacy-safe
weekly counts and work for any public repository.
...
`/chart/github/stars/{owner}/{repo}.svg` and `/chart/stars/{owner}/{repo}.svg`
render cumulative star history from GitHub's weekly counts. PNG and JSON
formats work at the same paths. These URLs render charts again after GitHub
introduced its privacy-safe history endpoint in September 2026.

See [star history](/docs/charts/star-history) for the builder, API details,
and an optional GitHub Action that commits charts to your repository.
...
| Chart | Source | Cache |
|-------|--------|-------|
| Stars | [GitHub star history API](https://docs.github.com/en/rest/activity/starring#get-repository-star-history) | 6h fresh · 30d last-known-good |
