...
import { renderBadge, renderErrorBadge } from "@shieldcn/core/badges/render"
import { resolveTheme, applyColorOverrides, statusColors } from "@shieldcn/core/badges/themes"
import { getSimpleIcon } from "@shieldcn/core/badges/simple-icons"
import { getProviderBrandColor } from "@shieldcn/core/badges/brand-colors"
import { parseSvg, decodeSvgDataUri } from "@shieldcn/core/badges/svg-parser"
import { trackEvent } from "@/lib/openpanel"
import { normalizeSearchParams } from "@shieldcn/core/normalize-params"
import type { BadgeData, BadgeConfig, BadgeStyle, BadgeSize } from "@shieldcn/core/badges/types"
...
} from "@shieldcn/core/providers/npm"
import {
  getGitHubStars,
  getGitHubForks,
  getGitHubWatchers,
  ...
  getGitHubFollowers,
  getGitHubUserStars,
} from "@shieldcn/core/providers/github"
import { getDiscordOnline, getDiscordByInvite } from "@shieldcn/core/providers/discord"
import { parseStaticBadgeContent, getDynamicJsonBadge } from "@shieldcn/core/providers/badge"
import { getRedditKarma, getRedditSubscribers } from "@shieldcn/core/providers/reddit"
import { getMemoBadge, upsertMemoBadge } from "@shieldcn/core/providers/memo"
import { getPyPIVersion, getPyPIDownloads, getPyPILicense, getPyPIPythonVersion } from "@shieldcn/core/providers/pypi"
import { getCratesVersion, getCratesDownloads, getCratesLicense } from "@shieldcn/core/providers/crates"
import { getDockerPulls, getDockerStars, getDockerVersion, getDockerSize } from "@shieldcn/core/providers/docker"
import { getBlueskyFollowers, getBlueskyFollowing, getBlueskyPosts } from "@shieldcn/core/providers/bluesky"
import { getJSRVersion, getJSRScore } from "@shieldcn/core/providers/jsr"
import { getBundleMin, getBundleMinGzip, getBundleTreeShaking } from "@shieldcn/core/providers/bundlephobia"
import { getYouTubeSubscribers, getYouTubeChannelViews, getYouTubeVideoViews, getYouTubeLikes, getYouTubeComments } from "@shieldcn/core/providers/youtube"
import { getVSCodeInstalls, getVSCodeRating, getVSCodeVersion } from "@shieldcn/core/providers/vscode"
import { getOCBackers, getOCSponsors, getOCContributors, getOCBalance, getOCBudget } from "@shieldcn/core/providers/opencollective"
import { getHNKarma } from "@shieldcn/core/providers/hackernews"
import { getMastodonFollowers, getMastodonFollowing, getMastodonPosts } from "@shieldcn/core/providers/mastodon"
import { getLemmySubscribers, getLemmyPosts, getLemmyComments } from "@shieldcn/core/providers/lemmy"
import { getPackagistVersion, getPackagistDownloads, getPackagistLicense } from "@shieldcn/core/providers/packagist"
import { getRubyGemsVersion, getRubyGemsDownloads, getRubyGemsLicense } from "@shieldcn/core/providers/rubygems"
import { getNuGetVersion, getNuGetDownloads } from "@shieldcn/core/providers/nuget"
import { getPubVersion, getPubLikes, getPubPoints, getPubPopularity } from "@shieldcn/core/providers/pub"
import { getHomebrewVersion, getHomebrewCaskVersion, getHomebrewInstalls, getHomebrewFormulaDownloads, getHomebrewCaskDownloads } from "@shieldcn/core/providers/homebrew"
import { getMavenVersion } from "@shieldcn/core/providers/maven"
import { getCocoaPodsVersion } from "@shieldcn/core/providers/cocoapods"
// import { getTwitchStatus, getTwitchFollowers } from "@shieldcn/core/providers/twitch" // disabled: needs TWITCH_CLIENT_ID + TWITCH_CLIENT_SECRET
import { getCodecovCoverage } from "@shieldcn/core/providers/codecov"
import { getWakaTimeCodingTime } from "@shieldcn/core/providers/wakatime"
import { getTokscaleTokens, getTokscaleCost, getTokscaleRank, getTokscaleActiveDays, getTokscaleStats } from "@shieldcn/core/providers/tokscale"
import { getIndieDevsUser } from "@shieldcn/core/providers/indiedevs"
