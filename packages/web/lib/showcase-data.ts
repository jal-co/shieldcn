...
export const categories: Category[] = [
  ...
  },
  {
    ...
    icons: [
      ...
      dynamicBadge("Powered by Neon", "database", "/badge/powered%20by-Neon-37C38F.svg?logo=neon&logoColor=fff&variant=branded", "Branded Neon badge — serverless Postgres."),
      dynamicBadge("Powered by Neon (outline)", "database", "/badge/powered%20by-Neon-37C38F.svg?logo=neon&variant=outline", "Subtle Neon badge for README rows."),
      dynamicBadge("Powered by Neon (secondary)", "database", "/badge/powered%20by-Neon-37C38F.svg?logo=neon&variant=secondary", "Neon badge in secondary style."),
